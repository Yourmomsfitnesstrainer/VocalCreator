...
Демка 0.1 имеет CLI и локальный HTTP-вход. Основная страница — десктопная студия. Karaoke MP4 удалён по BL-004.

## Content

| Вход | Файл | Назначение |
|---|---|---|
| `karaoke-gen` | @pyproject.toml, @src/karaoke_generator/cli.py | Команды `studio/doctor/web` |
...
| Постоянная песня | @scripts/check_reference_song.py | MP3/RTF, все 305 слов, полная мелодия и темп через работающий API |
